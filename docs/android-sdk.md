...
Download the Atar Android SDK AAR file from here: [https://host.atargrowth.com/public/atar-sdk-1.1.1.aar](https://host.atargrowth.com/public/atar-sdk-1.1.1.aar)
...
project-folder/libs/atar-sdk-1.1.1.aar
```
...
```groovy
dependencies {
    implementation files('libs/atar-sdk-1.1.1.aar')
}
```
